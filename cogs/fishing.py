...
class FishingCog(commands.Cog):
    ...
    async def fishing_stats(self, interaction: discord.Interaction, player: str, profile: str | None = None) -> None:
    ...
    @app_commands.describe(bait="The bait used", rod="The fishing rod used")
